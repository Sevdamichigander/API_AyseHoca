...
public class C04_Put_ResponseBilgileriAssertion {
    ...
    public void put02(){
      ...
      */
        ...
        reqbody.put("title","Fromage");
        reqbody.put("body","Salut");
        reqbody.put("userId",10);
        reqbody.put("id",70);
        ...
        Response response = given()
                                .contentType(ContentType.JSON)
                            .when()
                                .body(reqbody.toString()) // reqbody bir json objesi. onu java nin anlayacagi hale cevirmak icin toString() methodunu kullandik.
                .put(url);
