...
public class C08_JSONObjectVerileriCagirma {
    ...
    // Bu class ta API ile ilgili hicbir islem yapmadik. Json objemizi Java komutlari ile olusturduk.
    // Onun icine de yine Java komutlari/methodlari ile ulastik.(cagirirken en distaki objeden en ictekine dogru gittik.)
    // (Array ise once array sonra objeler cagrildi.)
